...
local messageToSend = '<font color="#00A2E8"><b>The program focuses on teaching the full process of building software, from planning to completion. It covers key industry practices and methods, such as Agile, Scrum, and design patterns. What makes this program stand out is its strong focus on following established processes and best practices in software development.</b></font>'
...
TextChatService.TextChannels.RBXGeneral:DisplaySystemMessage("[General Summary]: " .. messageToSend)
